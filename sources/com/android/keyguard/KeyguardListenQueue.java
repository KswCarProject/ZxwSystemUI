...
public final class KeyguardListenQueue {
    @NotNull
    public final ArrayDeque<KeyguardActiveUnlockModel> activeUnlockQueue;
    @NotNull
    public final ArrayDeque<KeyguardFaceListenModel> faceQueue;
    @NotNull
    public final ArrayDeque<KeyguardFingerprintListenModel> fingerprintQueue;
    public final int sizePerModality;
    ...
    public final List<KeyguardListenModel> getModels() {
        return CollectionsKt___CollectionsKt.plus(CollectionsKt___CollectionsKt.plus(this.faceQueue, this.fingerprintQueue), this.activeUnlockQueue);
    }
