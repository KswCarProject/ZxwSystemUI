...
public class KeyguardPasswordViewController extends KeyguardAbsKeyInputViewController<KeyguardPasswordView> {
    ...
    public final TextView.OnEditorActionListener mOnEditorActionListener = new KeyguardPasswordViewController$$ExternalSyntheticLambda0(this);
    ...
    public void onViewAttached() {
        ...
        this.mSwitchImeButton.setOnClickListener(new KeyguardPasswordViewController$$ExternalSyntheticLambda2(this));
        View findViewById = ((KeyguardPasswordView) this.mView).findViewById(R$id.cancel_button);
        if (findViewById != null) {
            findViewById.setOnClickListener(new KeyguardPasswordViewController$$ExternalSyntheticLambda3(this));
        }
