...
public final /* synthetic */ class DefaultTransitionHandler$$ExternalSyntheticLambda0 implements Runnable {
    ...
    public /* synthetic */ DefaultTransitionHandler$$ExternalSyntheticLambda0(DefaultTransitionHandler defaultTransitionHandler, ArrayList arrayList, IBinder iBinder, Transitions.TransitionFinishCallback transitionFinishCallback) {
    ...
    public final void run() {
        this.f$0.lambda$startAnimation$1(this.f$1, this.f$2, this.f$3);
    }
}
