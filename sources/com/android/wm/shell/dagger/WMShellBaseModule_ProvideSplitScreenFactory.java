...
public final class WMShellBaseModule_ProvideSplitScreenFactory implements Factory<Optional<SplitScreen>> {
    ...
    public static java.util.Optional<com.android.wm.shell.splitscreen.SplitScreen> provideSplitScreen(java.util.Optional<com.android.wm.shell.splitscreen.SplitScreenController> r0) {
        /*
            java.util.Optional r0 = com.android.wm.shell.dagger.WMShellBaseModule.provideSplitScreen(r0)
            java.lang.Object r0 = dagger.internal.Preconditions.checkNotNullFromProvides(r0)
            java.util.Optional r0 = (java.util.Optional) r0
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.wm.shell.dagger.WMShellBaseModule_ProvideSplitScreenFactory.provideSplitScreen(java.util.Optional):java.util.Optional");
    }
}
