...
public final class WMShellBaseModule_ProvideBubblesFactory implements Factory<Optional<Bubbles>> {
    public final Provider<Optional<BubbleController>> bubbleControllerProvider;
    ...
    public static java.util.Optional<com.android.wm.shell.bubbles.Bubbles> provideBubbles(java.util.Optional<com.android.wm.shell.bubbles.BubbleController> r0) {
        /*
            java.util.Optional r0 = com.android.wm.shell.dagger.WMShellBaseModule.provideBubbles(r0)
            java.lang.Object r0 = dagger.internal.Preconditions.checkNotNullFromProvides(r0)
            java.util.Optional r0 = (java.util.Optional) r0
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.wm.shell.dagger.WMShellBaseModule_ProvideBubblesFactory.provideBubbles(java.util.Optional):java.util.Optional");
    }
}
