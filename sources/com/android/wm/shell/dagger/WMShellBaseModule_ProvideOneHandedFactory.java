...
public final class WMShellBaseModule_ProvideOneHandedFactory implements Factory<Optional<OneHanded>> {
    ...
    public static java.util.Optional<com.android.wm.shell.onehanded.OneHanded> provideOneHanded(java.util.Optional<com.android.wm.shell.onehanded.OneHandedController> r0) {
        /*
            java.util.Optional r0 = com.android.wm.shell.dagger.WMShellBaseModule.provideOneHanded(r0)
            java.lang.Object r0 = dagger.internal.Preconditions.checkNotNullFromProvides(r0)
            java.util.Optional r0 = (java.util.Optional) r0
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.wm.shell.dagger.WMShellBaseModule_ProvideOneHandedFactory.provideOneHanded(java.util.Optional):java.util.Optional");
    }
}
