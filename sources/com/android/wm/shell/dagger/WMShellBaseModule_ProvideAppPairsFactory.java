...
public final class WMShellBaseModule_ProvideAppPairsFactory implements Factory<Optional<AppPairs>> {
    public final Provider<Optional<AppPairsController>> appPairsControllerProvider;
    ...
    public static java.util.Optional<com.android.wm.shell.apppairs.AppPairs> provideAppPairs(java.util.Optional<com.android.wm.shell.apppairs.AppPairsController> r0) {
        /*
            java.util.Optional r0 = com.android.wm.shell.dagger.WMShellBaseModule.provideAppPairs(r0)
            java.lang.Object r0 = dagger.internal.Preconditions.checkNotNullFromProvides(r0)
            java.util.Optional r0 = (java.util.Optional) r0
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.wm.shell.dagger.WMShellBaseModule_ProvideAppPairsFactory.provideAppPairs(java.util.Optional):java.util.Optional");
    }
}
