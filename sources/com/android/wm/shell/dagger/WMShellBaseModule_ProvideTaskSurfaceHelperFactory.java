...
public final class WMShellBaseModule_ProvideTaskSurfaceHelperFactory implements Factory<Optional<TaskSurfaceHelper>> {
    public final Provider<Optional<TaskSurfaceHelperController>> taskSurfaceControllerProvider;
    ...
    public static java.util.Optional<com.android.wm.shell.tasksurfacehelper.TaskSurfaceHelper> provideTaskSurfaceHelper(java.util.Optional<com.android.wm.shell.tasksurfacehelper.TaskSurfaceHelperController> r0) {
        /*
            java.util.Optional r0 = com.android.wm.shell.dagger.WMShellBaseModule.provideTaskSurfaceHelper(r0)
            java.lang.Object r0 = dagger.internal.Preconditions.checkNotNullFromProvides(r0)
            java.util.Optional r0 = (java.util.Optional) r0
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.wm.shell.dagger.WMShellBaseModule_ProvideTaskSurfaceHelperFactory.provideTaskSurfaceHelper(java.util.Optional):java.util.Optional");
    }
}
