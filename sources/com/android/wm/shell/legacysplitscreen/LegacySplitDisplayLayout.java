...
public class LegacySplitDisplayLayout {
    ...
    public final void adjustForIME(DisplayLayout displayLayout, int i, int i2, int i3, int i4, int i5, Rect rect, Rect rect2) {
    ...
    public static DividerSnapAlgorithm initSnapAlgorithmForRotation(Context context, DisplayLayout displayLayout, int i) {
        Configuration configuration = new Configuration();
        configuration.unset();
    ...
    public static int getPrimarySplitSide(Rect rect, Rect rect2, int i) {
        if (i == 1) {
