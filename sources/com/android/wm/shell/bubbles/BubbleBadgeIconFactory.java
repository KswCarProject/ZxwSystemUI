...
public class BubbleBadgeIconFactory extends BaseIconFactory {
    ...
    public BitmapInfo getBadgeBitmap(Drawable drawable, boolean z) {
        ...
        if (z) {
            ...
            int dimensionPixelSize = (int) ((float) this.mContext.getResources().getDimensionPixelSize(17105256));
    ...
    public final Bitmap getCircleBitmap(AdaptiveIconDrawable adaptiveIconDrawable, int i) {
