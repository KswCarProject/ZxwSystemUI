...
public class TaskStackListenerImpl extends TaskStackListener implements Handler.Callback {
    public static final String TAG = TaskStackListenerImpl.class.getSimpleName();
    public final IActivityTaskManager mActivityTaskManager;
    public Handler mMainHandler;
    public final List<TaskStackListenerCallback> mTaskStackListeners;
    public final List<TaskStackListenerCallback> mTmpListeners;
