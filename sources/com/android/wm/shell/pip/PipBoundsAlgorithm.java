...
public class PipBoundsAlgorithm {
    public static final String TAG = "PipBoundsAlgorithm";
    ...
    public final void reloadResources(Context context) {
        ...
        this.mMinAspectRatio = resources.getFloat(17105096);
        this.mMaxAspectRatio = resources.getFloat(17105095);
    ...
    public final Size adjustSizeToAspectRatio(Size size, float f) {
    ...
    public final int dpToPx(float f, DisplayMetrics displayMetrics) {
