...
public final class TvPipKeepClearAlgorithm$findMinMoveUp$generateEvents$1 extends Lambda implements Function1<Boolean, Function1<? super Rect, ? extends Unit>> {
    ...
    public TvPipKeepClearAlgorithm$findMinMoveUp$generateEvents$1(TvPipKeepClearAlgorithm tvPipKeepClearAlgorithm, Rect rect, List<TvPipKeepClearAlgorithm.SweepLineEvent> list) {
        super(1);
