...
public class PipPinchResizingAlgorithm {
    ...
    public final float overRotateInfluenceCurve(float f) {
        float f2 = f - 1.0f;
    ...
    public final void getCentroid(PointF pointF, PointF pointF2, PointF pointF3) {
        pointF3.set((pointF2.x + pointF.x) / 2.0f, (pointF2.y + pointF.y) / 2.0f);
    }

    public final float dot(PointF pointF, PointF pointF2) {
        return (pointF.x * pointF2.x) + (pointF.y * pointF2.y);
    }

    public final float cross(PointF pointF, PointF pointF2) {
        return (pointF.x * pointF2.y) - (pointF.y * pointF2.x);
    }

    public final void scaleRectAboutCenter(Rect rect, float f) {
        if (f != 1.0f) {
