...
public class IllustrationPreference extends Preference {
    ...
    public final Animatable2Compat.AnimationCallback mAnimationCallbackCompat = new Animatable2Compat.AnimationCallback() {
        public void onAnimationEnd(Drawable drawable) {
            ((Animatable) drawable).start();
        }
    };
    ...
    public final void handleImageWithAnimation(LottieAnimationView lottieAnimationView) {
    ...
    public static void startLottieAnimationWith(LottieAnimationView lottieAnimationView, Uri uri) {
    ...
    public static void startLottieAnimationWith(LottieAnimationView lottieAnimationView, int i) {
