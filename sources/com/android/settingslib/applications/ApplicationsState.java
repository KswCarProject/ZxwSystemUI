...
public class ApplicationsState {
    ...
    public static boolean isAppIconCacheEnabled(Context context) {
        return ThemeOverlayApplier.SETTINGS_PACKAGE.equals(context.getPackageName());
    }
    ...
    public class BackgroundHandler extends Handler {
        ...
        public final IPackageStatsObserver.Stub mStatsObserver = new IPackageStatsObserver.Stub() {
    ...
    public static class AppEntry extends SizeInfo {
        ...
        public boolean ensureIconLocked(Context context) {
            ...
            if (this.icon == null) {
                ...
                this.mounted = false;
                this.icon = context.getDrawable(17303702);
