...
public class EnableZenModeDialog {
    ...
    public void bind(Condition condition, View view, int i) {
        ...
        if (condition != null) {
            ...
            RadioButton radioButton = conditionTag2.rb;
            if (radioButton != null) {
                z = false;
            }
            if (radioButton == null) {
                conditionTag2.rb = (RadioButton) this.mZenRadioGroup.getChildAt(i);
            }
            ...
            conditionTag2.rb.setEnabled(z2);
            conditionTag2.rb.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
    ...
    public final String foreverSummary(Context context) {
        return context.getString(17041805);
    }
