...
public class IconNormalizer {
    ...
    public synchronized float getScale(android.graphics.drawable.Drawable r17, android.graphics.RectF r18, android.graphics.Path r19, boolean[] r20) {
        /*
            ...
            r3 = r20
            monitor-enter(r16)
            boolean r4 = r0 instanceof android.graphics.drawable.AdaptiveIconDrawable     // Catch:{ all -> 0x0129 }
            r5 = 0
            if (r4 == 0) goto L_0x0029
            float r3 = r1.mAdaptiveIconScale     // Catch:{ all -> 0x0129 }
            int r3 = (r3 > r5 ? 1 : (r3 == r5 ? 0 : -1))
            if (r3 != 0) goto L_0x001e
            int r3 = r1.mMaxSize     // Catch:{ all -> 0x0129 }
            android.graphics.RectF r4 = r1.mAdaptiveIconBounds     // Catch:{ all -> 0x0129 }
            float r0 = normalizeAdaptiveIcon(r0, r3, r4)     // Catch:{ all -> 0x0129 }
            r1.mAdaptiveIconScale = r0     // Catch:{ all -> 0x0129 }
        L_0x001e:
            if (r2 == 0) goto L_0x0025
            android.graphics.RectF r0 = r1.mAdaptiveIconBounds     // Catch:{ all -> 0x0129 }
            r2.set(r0)     // Catch:{ all -> 0x0129 }
        L_0x0025:
            float r0 = r1.mAdaptiveIconScale     // Catch:{ all -> 0x0129 }
            monitor-exit(r16)
            return r0
        L_0x0029:
            int r4 = r17.getIntrinsicWidth()     // Catch:{ all -> 0x0129 }
            int r6 = r17.getIntrinsicHeight()     // Catch:{ all -> 0x0129 }
            if (r4 <= 0) goto L_0x0048
            if (r6 > 0) goto L_0x0036
            goto L_0x0048
        L_0x0036:
            int r7 = r1.mMaxSize     // Catch:{ all -> 0x0129 }
            if (r4 > r7) goto L_0x003c
            if (r6 <= r7) goto L_0x0058
        L_0x003c:
            int r7 = java.lang.Math.max(r4, r6)     // Catch:{ all -> 0x0129 }
            int r8 = r1.mMaxSize     // Catch:{ all -> 0x0129 }
            int r4 = r4 * r8
            int r4 = r4 / r7
            int r8 = r8 * r6
            int r6 = r8 / r7
        ...
        L_0x004e:
            int r4 = r1.mMaxSize     // Catch:{ all -> 0x0129 }
        L_0x0050:
            if (r6 <= 0) goto L_0x0056
            int r7 = r1.mMaxSize     // Catch:{ all -> 0x0129 }
            if (r6 <= r7) goto L_0x0058
        L_0x0056:
            int r6 = r1.mMaxSize     // Catch:{ all -> 0x0129 }
        L_0x0058:
            android.graphics.Bitmap r7 = r1.mBitmap     // Catch:{ all -> 0x0129 }
            r8 = 0
            r7.eraseColor(r8)     // Catch:{ all -> 0x0129 }
            r0.setBounds(r8, r8, r4, r6)     // Catch:{ all -> 0x0129 }
            android.graphics.Canvas r7 = r1.mCanvas     // Catch:{ all -> 0x0129 }
            r0.draw(r7)     // Catch:{ all -> 0x0129 }
            byte[] r0 = r1.mPixels     // Catch:{ all -> 0x0129 }
            java.nio.ByteBuffer r0 = java.nio.ByteBuffer.wrap(r0)     // Catch:{ all -> 0x0129 }
            r0.rewind()     // Catch:{ all -> 0x0129 }
            android.graphics.Bitmap r7 = r1.mBitmap     // Catch:{ all -> 0x0129 }
            r7.copyPixelsToBuffer(r0)     // Catch:{ all -> 0x0129 }
            int r0 = r1.mMaxSize     // Catch:{ all -> 0x0129 }
            int r7 = r0 + 1
            int r0 = r0 - r4
            r10 = r8
            r14 = r10
        ...
        L_0x0083:
            ...
            byte[] r9 = r1.mPixels     // Catch:{ all -> 0x0129 }
            byte r9 = r9[r14]     // Catch:{ all -> 0x0129 }
        ...
        L_0x009b:
            int r14 = r14 + r0
            float[] r3 = r1.mLeftBorder     // Catch:{ all -> 0x0129 }
            float r9 = (float) r5     // Catch:{ all -> 0x0129 }
            r3[r10] = r9     // Catch:{ all -> 0x0129 }
            float[] r3 = r1.mRightBorder     // Catch:{ all -> 0x0129 }
            float r9 = (float) r8     // Catch:{ all -> 0x0129 }
            r3[r10] = r9     // Catch:{ all -> 0x0129 }
            r3 = -1
            ...
            r11 = r10
        L_0x00ac:
            int r3 = java.lang.Math.min(r7, r5)     // Catch:{ all -> 0x0129 }
            int r12 = java.lang.Math.max(r12, r8)     // Catch:{ all -> 0x0129 }
            r7 = r3
            r13 = r10
        L_0x00b6:
            int r10 = r10 + 1
        ...
        L_0x00bd:
            ...
            goto L_0x0127
        L_0x00c5:
            float[] r5 = r1.mLeftBorder     // Catch:{ all -> 0x0129 }
            r8 = 1
            convertToConvexArray(r5, r8, r11, r13)     // Catch:{ all -> 0x0129 }
            float[] r5 = r1.mRightBorder     // Catch:{ all -> 0x0129 }
            convertToConvexArray(r5, r3, r11, r13)     // Catch:{ all -> 0x0129 }
            r3 = 0
            r5 = 0
        L_0x00d2:
            if (r3 >= r6) goto L_0x00e9
            float[] r9 = r1.mLeftBorder     // Catch:{ all -> 0x0129 }
            r9 = r9[r3]     // Catch:{ all -> 0x0129 }
            r10 = -1082130432(0xffffffffbf800000, float:-1.0)
            int r10 = (r9 > r10 ? 1 : (r9 == r10 ? 0 : -1))
            if (r10 > 0) goto L_0x00df
            goto L_0x00e6
        L_0x00df:
            float[] r10 = r1.mRightBorder     // Catch:{ all -> 0x0129 }
            r10 = r10[r3]     // Catch:{ all -> 0x0129 }
            float r10 = r10 - r9
            float r10 = r10 + r0
            float r5 = r5 + r10
        L_0x00e6:
            ...
            goto L_0x00d2
        L_0x00e9:
            android.graphics.Rect r3 = r1.mBounds     // Catch:{ all -> 0x0129 }
            r3.left = r7     // Catch:{ all -> 0x0129 }
            r3.right = r12     // Catch:{ all -> 0x0129 }
            r3.top = r11     // Catch:{ all -> 0x0129 }
            r3.bottom = r13     // Catch:{ all -> 0x0129 }
            if (r2 == 0) goto L_0x0105
            float r3 = (float) r7     // Catch:{ all -> 0x0129 }
            float r9 = (float) r4     // Catch:{ all -> 0x0129 }
            float r3 = r3 / r9
            float r10 = (float) r11     // Catch:{ all -> 0x0129 }
            float r14 = (float) r6     // Catch:{ all -> 0x0129 }
            float r10 = r10 / r14
            float r15 = (float) r12     // Catch:{ all -> 0x0129 }
            float r15 = r15 / r9
            float r9 = r0 - r15
            float r15 = (float) r13     // Catch:{ all -> 0x0129 }
            float r15 = r15 / r14
            float r0 = r0 - r15
            r2.set(r3, r10, r9, r0)     // Catch:{ all -> 0x0129 }
        L_0x0105:
            r0 = r20
            if (r0 == 0) goto L_0x0119
            boolean r2 = r1.mEnableShapeDetection     // Catch:{ all -> 0x0129 }
            if (r2 == 0) goto L_0x0119
            int r2 = r0.length     // Catch:{ all -> 0x0129 }
            if (r2 <= 0) goto L_0x0119
            r2 = r19
            boolean r2 = r1.isShape(r2)     // Catch:{ all -> 0x0129 }
            r3 = 0
            r0[r3] = r2     // Catch:{ all -> 0x0129 }
        L_0x0119:
            int r13 = r13 + r8
            int r13 = r13 - r11
            int r12 = r12 + r8
            int r12 = r12 - r7
            int r13 = r13 * r12
            float r0 = (float) r13     // Catch:{ all -> 0x0129 }
            int r4 = r4 * r6
            float r2 = (float) r4     // Catch:{ all -> 0x0129 }
            float r0 = getScale(r5, r0, r2)     // Catch:{ all -> 0x0129 }
            monitor-exit(r16)
            return r0
        L_0x0127:
            monitor-exit(r16)
