...
public class SystemUIToast implements ToastPlugin.Toast {
    ...
    public final int mDefaultVerticalMargin;
    public final int mDefaultX;
    ...
    public final View inflateToastView() {
        ...
        if (applicationInfo == null || applicationInfo.targetSdkVersion >= 31) {
            ...
            if (badgedIcon == null) {
                ...
                if (applicationInfo == null) {
                    Log.d("SystemUIToast", "No appInfo for pkg=" + this.mPackageName + " usr=" + this.mUserId);
    ...
    public void onOrientationChange(int i) {
        ...
        this.mDefaultY = this.mContext.getResources().getDimensionPixelSize(17105613);
        this.mDefaultGravity = this.mContext.getResources().getInteger(17694952);
    }

    public final Animator createInAnimator() {
    ...
    public final Animator createOutAnimator() {
    ...
    public static boolean showApplicationIcon(ApplicationInfo applicationInfo, PackageManager packageManager) {
