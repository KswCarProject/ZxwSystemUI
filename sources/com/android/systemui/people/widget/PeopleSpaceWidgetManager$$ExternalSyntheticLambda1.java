...
public final /* synthetic */ class PeopleSpaceWidgetManager$$ExternalSyntheticLambda1 implements Runnable {
    ...
    public /* synthetic */ PeopleSpaceWidgetManager$$ExternalSyntheticLambda1(PeopleSpaceWidgetManager peopleSpaceWidgetManager, int[] iArr) {
        this.f$0 = peopleSpaceWidgetManager;
        this.f$1 = iArr;
    }

    public final void run() {
        this.f$0.lambda$updateWidgets$0(this.f$1);
    }
}
