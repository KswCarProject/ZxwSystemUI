...
public class ThemeOverlayApplier implements Dumpable {
    ...
    public static final List<String> THEME_CATEGORIES = Lists.newArrayList(new String[]{"android.theme.customization.system_palette", OVERLAY_CATEGORY_ICON_LAUNCHER, OVERLAY_CATEGORY_SHAPE, OVERLAY_CATEGORY_FONT, "android.theme.customization.accent_color", OVERLAY_CATEGORY_ICON_ANDROID, OVERLAY_CATEGORY_ICON_SYSUI, OVERLAY_CATEGORY_ICON_SETTINGS, OVERLAY_CATEGORY_ICON_THEME_PICKER});
    public final Executor mBgExecutor;
    public final Map<String, String> mCategoryToTargetPackage;
    public final String mLauncherPackage;
    public final OverlayManager mOverlayManager;
    public final Map<String, Set<String>> mTargetPackageToCategories;
    ...
    public /* synthetic */ void lambda$applyCurrentUserOverlays$7(Map map, FabricatedOverlay[] fabricatedOverlayArr, int i, Set set) {
        ...
        ((Set) hashSet.stream().map(new ThemeOverlayApplier$$ExternalSyntheticLambda1(this)).collect(Collectors.toSet())).forEach(new ThemeOverlayApplier$$ExternalSyntheticLambda2(this, arrayList));
        List<Pair> list = (List) arrayList.stream().filter(new ThemeOverlayApplier$$ExternalSyntheticLambda3(this)).filter(new ThemeOverlayApplier$$ExternalSyntheticLambda4(hashSet)).filter(new ThemeOverlayApplier$$ExternalSyntheticLambda5(map)).filter(new ThemeOverlayApplier$$ExternalSyntheticLambda6()).map(new ThemeOverlayApplier$$ExternalSyntheticLambda7()).collect(Collectors.toList());
