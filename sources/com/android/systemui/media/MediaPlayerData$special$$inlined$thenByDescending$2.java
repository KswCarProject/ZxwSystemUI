...
public final class MediaPlayerData$special$$inlined$thenByDescending$2<T> implements Comparator {
    ...
    public final int compare(T t, T t2) {
        ...
        return compare != 0 ? compare : ComparisonsKt__ComparisonsKt.compareValues(Boolean.valueOf(((MediaPlayerData.MediaSortKey) t2).getData().getActive()), Boolean.valueOf(((MediaPlayerData.MediaSortKey) t).getData().getActive()));
    }
}
