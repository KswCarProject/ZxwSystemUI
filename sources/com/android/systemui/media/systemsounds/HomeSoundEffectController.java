...
public class HomeSoundEffectController extends CoreStartable {
    ...
    public final boolean hasFlagNoSound(ActivityInfo activityInfo) {
    ...
    public final boolean shouldPlayHomeSoundForCurrentTransition(ActivityManager.RunningTaskInfo runningTaskInfo) {
    ...
    public final void updateLastTaskInfo(ActivityManager.RunningTaskInfo runningTaskInfo) {
    ...
    public final void handleTaskStackChanged(ActivityManager.RunningTaskInfo runningTaskInfo) {
