    ...
    public final class CreationAndCompletionThread extends Thread {
        ...
        public void run() {
            ...
            L_0x0095:
                ...
                r6.mNotificationRampTimeMs = r5     // Catch:{ all -> 0x00af }
                com.android.systemui.media.NotificationPlayer$Command r5 = r7.mCmd     // Catch:{ all -> 0x00af }
                android.media.AudioAttributes r5 = r5.attributes     // Catch:{ all -> 0x00af }
                r6 = 0
                r0.requestAudioFocus(r1, r5, r4, r6)     // Catch:{ all -> 0x00af }
                com.android.systemui.media.NotificationPlayer r4 = com.android.systemui.media.NotificationPlayer.this     // Catch:{ all -> 0x00af }
                r4.mAudioManagerWithAudioFocus = r0     // Catch:{ all -> 0x00af }
            L_0x00ad:
            ...
            L_0x00fc:
                ...
                r3.mPlayer = r2     // Catch:{ all -> 0x0124 }
            ...
            while (true) {
                ...
                if (i == 1) {
                    ...
                    synchronized (NotificationPlayer.this.mPlayerLock) {
                        r2 = NotificationPlayer.this.mPlayer;
                        NotificationPlayer.this.mPlayer = null;
                    }
                    if (r2 != null) {
                        long uptimeMillis = SystemClock.uptimeMillis() - command.requestTime;
                        if (uptimeMillis > 1000) {
                            String r0 = NotificationPlayer.this.mTag;
                            Log.w(r0, "Notification stop delayed by " + uptimeMillis + "msecs");
                        }
                        try {
                            r2.stop();
    ...
    public void setUsesWakeLock(Context context) {
        synchronized (this.mCmdQueue) {
            if (this.mWakeLock == null && this.mThread == null) {
                this.mWakeLock = ((PowerManager) context.getSystemService(GlobalActionsDialogLite.GLOBAL_ACTION_KEY_POWER)).newWakeLock(1, this.mTag);
            } else {
