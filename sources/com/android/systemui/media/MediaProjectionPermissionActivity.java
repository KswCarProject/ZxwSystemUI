    ...
    public void onCreate(Bundle bundle) {
        ...
        try {
            ...
            try {
                ...
                AlertDialog create = new AlertDialog.Builder(this, R$style.Theme_SystemUI_Dialog).setTitle(str).setIcon(R$drawable.ic_media_projection_permission).setMessage(charSequence).setPositiveButton(R$string.media_projection_action_text, this).setNeutralButton(17039360, this).setOnCancelListener(this).create();
                this.mDialog = create;
