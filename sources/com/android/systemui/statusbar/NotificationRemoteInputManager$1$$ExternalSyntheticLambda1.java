...
public final /* synthetic */ class NotificationRemoteInputManager$1$$ExternalSyntheticLambda1 implements NotificationRemoteInputManager.ClickHandler {
    ...
    public /* synthetic */ NotificationRemoteInputManager$1$$ExternalSyntheticLambda1(NotificationRemoteInputManager.AnonymousClass1 r1, RemoteViews.RemoteResponse remoteResponse, View view, NotificationEntry notificationEntry, PendingIntent pendingIntent) {
        this.f$0 = r1;
    ...
    public final boolean handleClick() {
        return this.f$0.lambda$onInteraction$1(this.f$1, this.f$2, this.f$3, this.f$4);
    }
}
