...
public final class KeyboardShortcuts {
    public static final String TAG = "KeyboardShortcuts";
    public static KeyboardShortcuts sInstance;
    public static final Object sLock = new Object();
    public final Comparator<KeyboardShortcutInfo> mApplicationItemsComparator = new Comparator<KeyboardShortcutInfo>() {
    ...
    public final DialogInterface.OnClickListener mDialogCloseListener = new DialogInterface.OnClickListener() {
    ...
    public final SparseArray<Drawable> mModifierDrawables = new SparseArray<>();
    public final int[] mModifierList = {65536, 4096, 2, 1, 4, 8};
    public final SparseArray<String> mModifierNames = new SparseArray<>();
    public final IPackageManager mPackageManager;
    public final SparseArray<Drawable> mSpecialCharacterDrawables = new SparseArray<>();
    public final SparseArray<String> mSpecialCharacterNames = new SparseArray<>();
    ...
    public static KeyboardShortcuts getInstance(Context context) {
        if (sInstance == null) {
    ...
    public final void loadResources(Context context) {
    ...
    public final void retrieveKeyCharacterMap(int i) {
    ...
    public final void showKeyboardShortcuts(int i) {
        ...
        ((WindowManager) this.mContext.getSystemService("window")).requestAppKeyboardShortcuts(new WindowManager.KeyboardShortcutsReceiver() {
            public void onKeyboardShortcutsReceived(List<KeyboardShortcutGroup> list) {
                ...
                KeyboardShortcutGroup r0 = KeyboardShortcuts.this.getDefaultApplicationShortcuts();
                if (r0 != null) {
                    list.add(r0);
                }
    ...
    public final KeyboardShortcutGroup getSystemShortcuts() {
    ...
    public final KeyboardShortcutGroup getDefaultApplicationShortcuts() {
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final android.graphics.drawable.Icon getIconForIntentCategory(java.lang.String r3, int r4) {
        /*
            r2 = this;
    ...
    public final PackageInfo getPackageInfoForIntent(Intent intent, int i) {
        try {
    ...
    public final void showKeyboardShortcutsDialog(final List<KeyboardShortcutGroup> list) {
    ...
    public final void handleShowKeyboardShortcuts(List<KeyboardShortcutGroup> list) {
    ...
    public final void populateKeyboardShortcuts(LinearLayout linearLayout, List<KeyboardShortcutGroup> list) {
    ...
    public final List<StringDrawableContainer> getHumanReadableShortcutKeys(KeyboardShortcutInfo keyboardShortcutInfo) {
        String str;
    ...
    public final List<StringDrawableContainer> getHumanReadableModifiers(KeyboardShortcutInfo keyboardShortcutInfo) {
        ArrayList arrayList = new ArrayList();
