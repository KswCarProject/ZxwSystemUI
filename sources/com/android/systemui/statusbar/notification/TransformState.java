...
public class TransformState {
    ...
    public static ViewClippingUtil.ClippingParameters CLIPPING_PARAMETERS = new ViewClippingUtil.ClippingParameters() {
    ...
    public static final int TRANSFORMATION_START_SCLALE_X = R$id.transformation_start_scale_x_tag;
    public static final int TRANSFORMATION_START_SCLALE_Y = R$id.transformation_start_scale_y_tag;
    public static final int TRANSFORMATION_START_X = R$id.transformation_start_x_tag;
    public static final int TRANSFORMATION_START_Y = R$id.transformation_start_y_tag;
