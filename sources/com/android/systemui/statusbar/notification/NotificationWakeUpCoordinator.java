...
public final class NotificationWakeUpCoordinator implements OnHeadsUpChangedListener, StatusBarStateController.StateListener, PanelExpansionListener {
    ...
    @NotNull
    public final Set<NotificationEntry> mEntrySetToClearWhenFinished = new LinkedHashSet();
    @NotNull
    ...
    public float mNotificationVisibleAmount;
    ...
    public NotificationWakeUpCoordinator(@NotNull HeadsUpManager headsUpManager, @NotNull StatusBarStateController statusBarStateController2, @NotNull KeyguardBypassController keyguardBypassController, @NotNull DozeParameters dozeParameters2, @NotNull ScreenOffAnimationController screenOffAnimationController2) {
    ...
    public final void setNotificationsFullyHidden(boolean z) {
    ...
    public final boolean overrideDozeAmountIfAnimatingScreenOff(float f) {
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final void startVisibilityAnimation(boolean r7) {
        /*
            r6 = this;
    ...
    public final void handleAnimationFinished() {
        boolean z = true;
