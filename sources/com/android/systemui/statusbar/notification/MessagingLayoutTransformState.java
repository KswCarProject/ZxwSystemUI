...
public class MessagingLayoutTransformState extends TransformState {
    ...
    public MessagingLinearLayout mMessageContainer;
    ...
    public final void appear(MessagingGroup messagingGroup, float f) {
    ...
    public final void adaptGroupAppear(MessagingGroup messagingGroup, float f, float f2, boolean z) {
        float f3;
        if (z) {
    ...
    public final void disappear(MessagingGroup messagingGroup, float f) {
        MessagingLinearLayout messageContainer = messagingGroup.getMessageContainer();
        for (int i = 0; i < messageContainer.getChildCount(); i++) {
            View childAt = messageContainer.getChildAt(i);
            if (!isGone(childAt)) {
    ...
    public final ArrayList<MessagingGroup> filterHiddenGroups(ArrayList<MessagingGroup> arrayList) {
    ...
    public final boolean hasEllipses(TextView textView) {
    ...
    public final boolean needsReflow(TextView textView, TextView textView2) {
    ...
    public final int transformGroups(com.android.internal.widget.MessagingGroup r22, com.android.internal.widget.MessagingGroup r23, float r24, boolean r25) {
        /*
            r21 = this;
            r7 = r21
    ...
    public final HashMap<MessagingGroup, MessagingGroup> findPairs(ArrayList<MessagingGroup> arrayList, ArrayList<MessagingGroup> arrayList2) {
