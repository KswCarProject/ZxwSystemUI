...
public class InstantAppNotifier extends CoreStartable implements CommandQueue.Callbacks, KeyguardStateController.Callback {
    ...
    public InstantAppNotifier(Context context, CommandQueue commandQueue, Executor executor) {
        super(context);
    ...
    /* access modifiers changed from: private */
    public /* synthetic */ void lambda$updateForegroundInstantApps$1(NotificationManager notificationManager, IPackageManager iPackageManager) {
        int windowingMode;
        ...
        arraySet.forEach(new InstantAppNotifier$$ExternalSyntheticLambda1(this, notificationManager));
    }

    /* access modifiers changed from: private */
    public /* synthetic */ void lambda$updateForegroundInstantApps$0(NotificationManager notificationManager, Pair pair) {
    ...
    public final Intent getTaskIntent(int i, int i2) {
