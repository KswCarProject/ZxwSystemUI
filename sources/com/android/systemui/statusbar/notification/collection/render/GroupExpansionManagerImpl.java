...
public class GroupExpansionManagerImpl implements GroupExpansionManager, Coordinator {
    public final Set<NotificationEntry> mExpandedGroups = new HashSet();
    public final GroupMembershipManager mGroupMembershipManager;
    public final OnBeforeRenderListListener mNotifTracker = new GroupExpansionManagerImpl$$ExternalSyntheticLambda0(this);
    public final Set<GroupExpansionManager.OnGroupExpansionChangeListener> mOnGroupChangeListeners = new HashSet();
    ...
    public final void sendOnGroupExpandedChange(NotificationEntry notificationEntry, boolean z) {
