...
public class GroupCoalescer implements Dumpable {
    public final Map<String, EventBatch> mBatches;
    public final SystemClock mClock;
    public final Map<String, CoalescedEvent> mCoalescedEvents;
    public final Comparator<CoalescedEvent> mEventComparator;
    ...
    public final void maybeEmitBatch(StatusBarNotification statusBarNotification) {
    ...
    public final boolean handleNotificationPosted(StatusBarNotification statusBarNotification, NotificationListenerService.RankingMap rankingMap) {
    ...
    public final EventBatch getOrBuildBatch(String str) {
    ...
    public final void resetShortTimeout(EventBatch eventBatch) {
        Runnable runnable = eventBatch.mCancelShortTimeout;
        if (runnable != null) {
            runnable.run();
        }
        eventBatch.mCancelShortTimeout = this.mMainExecutor.executeDelayed(new GroupCoalescer$$ExternalSyntheticLambda1(this, eventBatch), this.mMinGroupLingerDuration);
    }
    ...
    public final NotificationListenerService.Ranking requireRanking(NotificationListenerService.RankingMap rankingMap, String str) {
