...
public final class NotifBindPipeline {
    ...
    public final NotifCollectionListener mCollectionListener;
    public final NotifBindPipelineLogger mLogger;
    public final Handler mMainHandler;
    public final List<BindCallback> mScratchCallbacksList = new ArrayList();
    ...
    public final void onBindRequested(NotificationEntry notificationEntry, CancellationSignal cancellationSignal, BindCallback bindCallback) {
        BindEntry bindEntry = getBindEntry(notificationEntry);
        if (bindEntry != null) {
            ...
            if (bindCallback != null) {
                ...
                cancellationSignal.setOnCancelListener(new NotifBindPipeline$$ExternalSyntheticLambda2(set, bindCallback));
            }
            requestPipelineRun(notificationEntry);
        }
    }
    ...
    public final void startPipeline(NotificationEntry notificationEntry) {
        this.mLogger.logStartPipeline(notificationEntry.getKey());
        if (this.mStage != null) {
            this.mStage.executeStage(notificationEntry, this.mBindEntries.get(notificationEntry).row, new NotifBindPipeline$$ExternalSyntheticLambda0(this));
            return;
        }
    ...
    public final void lambda$startPipeline$1(NotificationEntry notificationEntry) {
        BindEntry bindEntry = getBindEntry(notificationEntry);
        Set<BindCallback> set = bindEntry.callbacks;
    ...
    public final BindEntry getBindEntry(NotificationEntry notificationEntry) {
