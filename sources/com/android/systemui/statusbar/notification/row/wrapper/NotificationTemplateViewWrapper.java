...
public class NotificationTemplateViewWrapper extends NotificationHeaderViewWrapper {
    ...
    public NotificationTemplateViewWrapper(Context context, View view, ExpandableNotificationRow expandableNotificationRow) {
        ...
        this.mTransformationHelper.setCustomTransformation(new ViewTransformationHelper.CustomTransformation() {
            ...
            public final float getTransformationY(TransformState transformState, TransformState transformState2) {
        ...
        this.mFullHeaderTranslation = context.getResources().getDimensionPixelSize(17105385) - context.getResources().getDimensionPixelSize(17105388);
    }
    ...
    public final void updatePendingIntentCancellations() {
        ...
        if (notificationActionListLayout != null) {
            ...
            for (int i = 0; i < childCount; i++) {
                ...
                performOnPendingIntentCancellation(button, new NotificationTemplateViewWrapper$$ExternalSyntheticLambda0(this, button));
            }
        }
    }
    ...
    public final int blendColorWithBackground(int i, float f) {
    ...
    public final void performOnPendingIntentCancellation(View view, Runnable runnable) {
    ...
    public /* synthetic */ void lambda$performOnPendingIntentCancellation$2(PendingIntent pendingIntent, Runnable runnable, PendingIntent pendingIntent2) {
        this.mView.post(new NotificationTemplateViewWrapper$$ExternalSyntheticLambda3(this, pendingIntent, runnable));
    }
    ...
    public final void updateActionOffset() {
