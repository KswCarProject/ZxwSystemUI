...
public class NotificationConversationInfo extends LinearLayout implements NotificationGuts.GutsContent {
    ...
    public OnConversationSettingsClickListener mOnConversationSettingsClickListener;
    public View.OnClickListener mOnDefaultClick = new NotificationConversationInfo$$ExternalSyntheticLambda1(this);
    public View.OnClickListener mOnDone = new NotificationConversationInfo$$ExternalSyntheticLambda3(this);
    public View.OnClickListener mOnFavoriteClick = new NotificationConversationInfo$$ExternalSyntheticLambda0(this);
    public View.OnClickListener mOnMuteClick = new NotificationConversationInfo$$ExternalSyntheticLambda2(this);
    ...
    public final View.OnClickListener getSettingsOnClickListener() {
        ...
        return new NotificationConversationInfo$$ExternalSyntheticLambda8(this, i);
    }
    ...
    public final void bindConversationDetails() {
    ...
    public final void updateChannel() {
        ...
        this.mMainHandler.postDelayed(new NotificationConversationInfo$$ExternalSyntheticLambda7(this), 360);
    }
