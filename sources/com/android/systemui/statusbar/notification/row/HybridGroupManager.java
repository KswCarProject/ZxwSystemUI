...
public class HybridGroupManager {
    ...
    public final HybridNotificationView inflateHybridViewWithStyle(int i, View view, ViewGroup viewGroup) {
        int i2;
    ...
    public final TextView inflateOverflowNumber(ViewGroup viewGroup) {
    ...
    public final void updateOverFlowNumberColor(TextView textView) {
    ...
    public final HybridNotificationView bindFromNotificationWithStyle(HybridNotificationView hybridNotificationView, View view, StatusBarNotification statusBarNotification, int i, ViewGroup viewGroup) {
