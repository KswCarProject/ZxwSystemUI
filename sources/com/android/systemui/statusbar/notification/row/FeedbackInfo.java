...
public class FeedbackInfo extends LinearLayout implements NotificationGuts.GutsContent {
    public static final boolean DEBUG = Log.isLoggable("FeedbackInfo", 3);
    ...
    public final void positiveFeedback(View view) {
        this.mGutsContainer.closeControls(view, false);
        handleFeedback(true);
    }

    public final void negativeFeedback(View view) {
    ...
    public final void sendFeedbackToAssistant(Bundle bundle) {
