...
public class NotificationMenuRow implements NotificationMenuRowPlugin, View.OnClickListener, ExpandableNotificationRow.LayoutListener {
    ...
    public NotificationMenuRowPlugin.MenuItem mFeedbackItem;
    ...
    public final Map<View, NotificationMenuRowPlugin.MenuItem> mMenuItemsByView = new ArrayMap();
    ...
    public NotificationMenuRowPlugin.MenuItem mSnoozeItem;
    ...
    public static NotificationMenuRowPlugin.MenuItem createFeedbackItem(Context context) {
    ...
    public final void addMenuView(NotificationMenuRowPlugin.MenuItem menuItem, ViewGroup viewGroup) {
        View menuView = menuItem.getMenuView();
        if (menuView != null) {
