...
public class NotificationChildrenContainer extends ViewGroup implements NotificationFadeAware {
    public static final AnimationProperties ALPHA_FADE_IN = new AnimationProperties() {
        public AnimationFilter mAnimationFilter = new AnimationFilter().animateAlpha();
    ...
    public final List<ExpandableNotificationRow> mAttachedChildren;
    ...
    public final List<View> mDividers;
    ...
    public final void initDimens() {
        ...
        this.mCollapsedBottomPadding = (float) resources.getDimensionPixelOffset(R$dimen.notification_children_collapsed_bottom_padding);
        ...
        this.mTranslationForHeader = resources.getDimensionPixelOffset(17105385) - this.mNotificationHeaderMargin;
    ...
    public final void recreateLowPriorityHeader(Notification.Builder builder, boolean z) {
    ...
    public final void setExpandButtonNumber(NotificationViewWrapper notificationViewWrapper) {
    ...
    public final int getIntrinsicHeight(float f) {
        float f2;
        float f3;
        int i;
    ...
    public final void startChildAlphaAnimations(boolean z) {
        float f = z ? 1.0f : 0.0f;
        float f2 = 1.0f - f;
        int size = this.mAttachedChildren.size();
        int i = 0;
    ...
    public final void updateHeaderTransformation() {
        if (this.mUserLocked && showingAsLowPriority()) {
            float groupExpandFraction = getGroupExpandFraction();
    ...
    public final int getVisibleChildrenExpandHeight() {
        int i;
