...
public class NotificationUiAdjustment {
    ...
    public static boolean areDifferent(Icon icon, Icon icon2) {
        if (icon == icon2) {
            return false;
        }
    ...
    public static boolean areDifferent(RemoteInput[] remoteInputArr, RemoteInput[] remoteInputArr2) {
    ...
    public static boolean areDifferent(CharSequence[] charSequenceArr, CharSequence[] charSequenceArr2) {
