...
public class PreviewInflater {
    ...
    public final View inflateWidgetView(WidgetInfo widgetInfo) {
        try {
    ...
    public final WidgetInfo getWidgetInfoFromService(ComponentName componentName) {
        try {
    ...
    public final WidgetInfo getWidgetInfoFromMetaData(String str, Bundle bundle) {
        int i;
    ...
    public final WidgetInfo getWidgetInfo(Intent intent) {
