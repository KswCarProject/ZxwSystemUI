...
public class CastControllerImpl implements CastController {
    ...
    public final MediaRouter.SimpleCallback mMediaCallback = new MediaRouter.SimpleCallback() {
    ...
    public final MediaProjectionManager.Callback mProjectionCallback;
    ...
    public CastControllerImpl(Context context, DumpManager dumpManager) {
        AnonymousClass2 r0 = new MediaProjectionManager.Callback() {
    ...
    public final void setProjection(MediaProjectionInfo mediaProjectionInfo, boolean z) {
        boolean z2;
    ...
    public final void updateRemoteDisplays() {
        synchronized (this.mRoutes) {
            this.mRoutes.clear();
    ...
    public final void ensureTagExists(MediaRouter.RouteInfo routeInfo) {
    ...
    public final void fireOnCastDevicesChanged(CastController.Callback callback) {
