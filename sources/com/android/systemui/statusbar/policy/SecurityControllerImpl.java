...
public class SecurityControllerImpl extends CurrentUserTracker implements SecurityController {
    ...
    public final ComponentName getProfileOwnerOrDeviceOwnerSupervisionComponent() {
        return this.mDevicePolicyManager.getProfileOwnerOrDeviceOwnerSupervisionComponent(new UserHandle(this.mCurrentUserId));
    }

    public final ComponentName getProfileOwnerOrDeviceOwnerComponent() {
        return getProfileOwnerOrDeviceOwnerSupervisionComponent();
    }

    public final DeviceAdminInfo getDeviceAdminInfo(ComponentName componentName) {
        try {
    ...
    public final void refreshCACerts(int i) {
    ...
    public final String getPackageNameForVpnConfig(VpnConfig vpnConfig) {
        if (vpnConfig.legacy) {
            return null;
        }
    ...
    public final boolean isVpnPackageBranded(String str) {
        try {
