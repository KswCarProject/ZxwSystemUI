...
public class KeyguardUserSwitcherController extends ViewController<KeyguardUserSwitcherView> {
    ...
    public final KeyguardUpdateMonitorCallback mInfoCallback = new KeyguardUpdateMonitorCallback() {
    ...
    public final StatusBarStateController.StateListener mStatusBarStateListener = new StatusBarStateController.StateListener() {
        public void onStateChanged(int i) {
            ...
            int r3 = KeyguardUserSwitcherController.this.mBarState;
            ...
            KeyguardUserSwitcherController.this.setKeyguardUserSwitcherVisibility(i, isKeyguardFadingAway, goingToFullShade, r3);
        }
    ...
    public final boolean isUserSwitcherOpen() {
