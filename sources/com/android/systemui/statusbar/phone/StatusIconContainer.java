...
public class StatusIconContainer extends AlphaOptimizedLinearLayout {
    ...
    private void initDimens() {
        this.mIconDotFrameWidth = getResources().getDimensionPixelSize(17105555);
    ...
    public final boolean addIgnoredSlotInternal(String str) {
    ...
    public static StatusIconState getViewStateFromChild(View view) {
    ...
    public static int getViewTotalWidth(View view) {
