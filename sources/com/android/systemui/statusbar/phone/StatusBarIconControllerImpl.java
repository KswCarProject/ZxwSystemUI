...
public class StatusBarIconControllerImpl extends StatusBarIconList implements TunerService.Tunable, ConfigurationController.ConfigurationListener, Dumpable, CommandQueue.Callbacks, StatusBarIconController, DemoMode {
    ...
    public final void addSystemIcon(int i, StatusBarIconHolder statusBarIconHolder) {
        String slotName = getSlotName(i);
        this.mIconGroups.forEach(new StatusBarIconControllerImpl$$ExternalSyntheticLambda2(getViewIndex(i, statusBarIconHolder.getTag()), slotName, this.mIconHideList.contains(slotName), statusBarIconHolder));
    }
    ...
    public void setExternalIcon(String str) {
        this.mIconGroups.forEach(new StatusBarIconControllerImpl$$ExternalSyntheticLambda3(getViewIndex(getSlotIndex(str), 0), this.mContext.getResources().getDimensionPixelSize(R$dimen.status_bar_icon_drawing_size)));
    }
    ...
    public final void setIcon(int i, StatusBarIcon statusBarIcon) {
        String slotName = getSlotName(i);
    ...
    public void setIconAccessibilityLiveRegion(String str, int i) {
        ...
        if (slot.hasIconsInSlot()) {
            ...
            for (StatusBarIconHolder tag : slot.getHolderListInViewOrder()) {
                this.mIconGroups.forEach(new StatusBarIconControllerImpl$$ExternalSyntheticLambda5(getViewIndex(slotIndex, tag.getTag()), i));
            }
        }
    }
    ...
    public void removeIcon(int i, int i2) {
        if (getIcon(i, i2) != null) {
            ...
            this.mIconGroups.forEach(new StatusBarIconControllerImpl$$ExternalSyntheticLambda4(getViewIndex(i, 0)));
        }
    }

    public final void handleSet(int i, StatusBarIconHolder statusBarIconHolder) {
        this.mIconGroups.forEach(new StatusBarIconControllerImpl$$ExternalSyntheticLambda1(getViewIndex(i, statusBarIconHolder.getTag()), statusBarIconHolder));
    }
