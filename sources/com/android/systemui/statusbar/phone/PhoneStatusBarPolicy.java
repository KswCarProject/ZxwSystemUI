...
public class PhoneStatusBarPolicy implements BluetoothController.Callback, CommandQueue.Callbacks, RotationLockController.RotationLockControllerCallback, DataSaverController.Listener, ZenModeController.Callback, DeviceProvisionedController.DeviceProvisionedListener, KeyguardStateController.Callback, PrivacyItemController.Callback, LocationController.LocationChangeCallback, RecordingController.RecordingStateChangeCallback {
    ...
    public final NextAlarmController.NextAlarmChangeCallback mNextAlarmCallback = new NextAlarmController.NextAlarmChangeCallback() {
    ...
    public Runnable mRemoveCastIconRunnable = new Runnable() {
        public void run() {
    ...
    public final SensorPrivacyController.OnSensorPrivacyChangedListener mSensorPrivacyListener = new SensorPrivacyController.OnSensorPrivacyChangedListener() {
    ...
    public final SynchronousUserSwitchObserver mUserSwitchListener = new SynchronousUserSwitchObserver() {
        /* access modifiers changed from: private */
    ...
    public PhoneStatusBarPolicy(StatusBarIconController statusBarIconController, CommandQueue commandQueue, BroadcastDispatcher broadcastDispatcher, Executor executor, Resources resources, CastController castController, HotspotController hotspotController, BluetoothController bluetoothController, NextAlarmController nextAlarmController, UserInfoController userInfoController, RotationLockController rotationLockController, DataSaverController dataSaverController, ZenModeController zenModeController, DeviceProvisionedController deviceProvisionedController, KeyguardStateController keyguardStateController, LocationController locationController, SensorPrivacyController sensorPrivacyController, IActivityManager iActivityManager, AlarmManager alarmManager, UserManager userManager, DevicePolicyManager devicePolicyManager, RecordingController recordingController, TelecomManager telecomManager, int i, SharedPreferences sharedPreferences, DateFormatUtil dateFormatUtil, RingerModeTracker ringerModeTracker, PrivacyItemController privacyItemController, PrivacyLogger privacyLogger) {
        ...
        this.mSlotCast = resources.getString(17041561);
        this.mSlotHotspot = resources.getString(17041568);
        this.mSlotBluetooth = resources.getString(17041558);
        this.mSlotTty = resources.getString(17041586);
        this.mSlotZen = resources.getString(17041590);
        this.mSlotMute = resources.getString(17041574);
        this.mSlotVibrate = resources.getString(17041587);
        this.mSlotAlarmClock = resources.getString(17041556);
        this.mSlotManagedProfile = resources.getString(17041571);
        this.mSlotRotate = resources.getString(17041579);
        this.mSlotHeadset = resources.getString(17041567);
        this.mSlotDataSaver = resources.getString(17041565);
        this.mSlotLocation = resources.getString(17041570);
        this.mSlotMicrophone = resources.getString(17041572);
        this.mSlotCamera = resources.getString(17041560);
        this.mSlotSensorsOff = resources.getString(17041582);
        this.mSlotScreenRecord = resources.getString(17041580);
        this.mDisplayId = i;
    ...
    public void init() {
        ...
        PhoneStatusBarPolicy$$ExternalSyntheticLambda7 phoneStatusBarPolicy$$ExternalSyntheticLambda7 = new PhoneStatusBarPolicy$$ExternalSyntheticLambda7(this);
        this.mRingerModeTracker.getRingerMode().observeForever(phoneStatusBarPolicy$$ExternalSyntheticLambda7);
        this.mRingerModeTracker.getRingerModeInternal().observeForever(phoneStatusBarPolicy$$ExternalSyntheticLambda7);
        try {
    ...
    public final String getManagedProfileAccessibilityString() {
        return this.mDevicePolicyManager.getResources().getString("SystemUi.STATUS_BAR_WORK_ICON_ACCESSIBILITY", new PhoneStatusBarPolicy$$ExternalSyntheticLambda6(this));
    }

    /* access modifiers changed from: private */
    public /* synthetic */ String lambda$getManagedProfileAccessibilityString$1() {
    ...
    public final String buildAlarmContentDescription() {
    ...
    public final void updateManagedProfile() {
        this.mUiBgExecutor.execute(new PhoneStatusBarPolicy$$ExternalSyntheticLambda2(this));
    }

    /* access modifiers changed from: private */
    public /* synthetic */ void lambda$updateManagedProfile$3() {
        try {
            this.mHandler.post(new PhoneStatusBarPolicy$$ExternalSyntheticLambda3(this, this.mUserManager.isManagedProfile(ActivityTaskManager.getService().getLastResumedActivityUserId()), getManagedProfileAccessibilityString()));
    ...
    /* access modifiers changed from: private */
    public /* synthetic */ void lambda$updateManagedProfile$2(boolean z, String str) {
        boolean z2;
        if (!z || (this.mKeyguardStateController.isShowing() && !this.mKeyguardStateController.isOccluded())) {
            z2 = false;
        } else {
            z2 = true;
            this.mIconController.setIcon(this.mSlotManagedProfile, R$drawable.stat_sys_managed_profile_status, str);
        }
    ...
    public final void updateHeadsetPlug(Intent intent) {
        int i;
        int i2;
    ...
    public final void updatePrivacyItems(List<PrivacyItem> list) {
        boolean z = false;
        boolean z2 = false;
        boolean z3 = false;
        for (PrivacyItem next : list) {
            if (next != null) {
                int i = AnonymousClass8.$SwitchMap$com$android$systemui$privacy$PrivacyType[next.getPrivacyType().ordinal()];
                if (i == 1) {
                    z = true;
                } else if (i == 2) {
                    z3 = true;
                ...
                this.mPrivacyItemController.dump(new PrintWriter(stringWriter), (String[]) null);
    ...
    public final void updateLocationFromController() {
    ...
    /* access modifiers changed from: private */
    public /* synthetic */ void lambda$onRecordingStart$6() {
        this.mIconController.setIconVisibility(this.mSlotScreenRecord, true);
    }
    ...
    /* access modifiers changed from: private */
    public /* synthetic */ void lambda$onRecordingEnd$7() {
        this.mIconController.setIconVisibility(this.mSlotScreenRecord, false);
    }

    public final void updateHotspotIcon(int i) {
        if (i == 6) {
