...
public final class StatusBarTouchableRegionManager implements Dumpable {
    ...
    public final ViewTreeObserver.OnComputeInternalInsetsListener mOnComputeInternalInsetsListener = new ViewTreeObserver.OnComputeInternalInsetsListener() {
    ...
    public final void initResources() {
        this.mDisplayCutoutTouchableRegionSize = this.mContext.getResources().getDimensionPixelSize(17105202);
    ...
    public final void updateTouchableRegionAfterLayout() {
