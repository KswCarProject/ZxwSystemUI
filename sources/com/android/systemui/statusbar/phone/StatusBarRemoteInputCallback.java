...
public class StatusBarRemoteInputCallback implements NotificationRemoteInputManager.Callback, CommandQueue.Callbacks, StatusBarStateController.StateListener {
    ...
    public BroadcastReceiver mChallengeReceiver;
    ...
    public void onStateChanged(int i) {
        ...
        if ((this.mStatusBarStateController.leaveOpenOnKeyguardHide() || z) && !this.mStatusBarStateController.isKeyguardRequested() && this.mKeyguardStateController.isUnlocked()) {
            if (z) {
                ...
                executor.execute(new StatusBarRemoteInputCallback$$ExternalSyntheticLambda0(view));
            }
    ...
    public void onWorkChallengeChanged() {
        ...
        if (this.mPendingWorkRemoteInputView != null && !this.mLockscreenUserManager.isAnyProfilePublicMode()) {
            this.mShadeController.postOnShadeExpanded(new StatusBarRemoteInputCallback$$ExternalSyntheticLambda1(this));
    ...
    public /* synthetic */ void lambda$onWorkChallengeChanged$2() {
        ...
        if (view != null) {
            ...
            if (parent2 instanceof NotificationStackScrollLayout) {
                ...
                expandableNotificationRow.post(new StatusBarRemoteInputCallback$$ExternalSyntheticLambda3(this, (NotificationStackScrollLayout) parent2, expandableNotificationRow));
            }
        }
    }
    ...
    public /* synthetic */ void lambda$onWorkChallengeChanged$1(NotificationStackScrollLayout notificationStackScrollLayout, ExpandableNotificationRow expandableNotificationRow) {
        StatusBarRemoteInputCallback$$ExternalSyntheticLambda4 statusBarRemoteInputCallback$$ExternalSyntheticLambda4 = new StatusBarRemoteInputCallback$$ExternalSyntheticLambda4(this, notificationStackScrollLayout);
        if (notificationStackScrollLayout.scrollTo(expandableNotificationRow)) {
            notificationStackScrollLayout.setFinishScrollingCallback(statusBarRemoteInputCallback$$ExternalSyntheticLambda4);
        } else {
            statusBarRemoteInputCallback$$ExternalSyntheticLambda4.run();
        }
    }
    ...
    public boolean handleRemoteViewClick(View view, PendingIntent pendingIntent, boolean z, NotificationRemoteInputManager.ClickHandler clickHandler) {
        ...
        this.mActivityStarter.dismissKeyguardThenExecute(new StatusBarRemoteInputCallback$$ExternalSyntheticLambda2(this, pendingIntent, clickHandler), (Runnable) null, this.mActivityIntentHelper.wouldLaunchResolverActivity(pendingIntent.getIntent(), this.mLockscreenUserManager.getCurrentUserId()));
        return true;
    }
