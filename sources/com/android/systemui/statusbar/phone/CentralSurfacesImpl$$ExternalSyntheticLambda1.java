...
public final /* synthetic */ class CentralSurfacesImpl$$ExternalSyntheticLambda1 implements Runnable {
    ...
    public /* synthetic */ CentralSurfacesImpl$$ExternalSyntheticLambda1(CentralSurfacesImpl centralSurfacesImpl, ActivityLaunchAnimator.Controller controller, PendingIntent pendingIntent, boolean z, boolean z2, Runnable runnable) {
    ...
    public final void run() {
        this.f$0.lambda$startPendingIntentDismissingKeyguard$40(this.f$1, this.f$2, this.f$3, this.f$4, this.f$5);
    }
}
