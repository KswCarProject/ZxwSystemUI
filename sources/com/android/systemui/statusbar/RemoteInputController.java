...
public class RemoteInputController {
    ...
    public void dump(IndentingPrintWriter indentingPrintWriter) {
        ...
        DumpUtilsKt.withIncreasedIndent(indentingPrintWriter, new RemoteInputController$$ExternalSyntheticLambda0(this, indentingPrintWriter));
        indentingPrintWriter.println("mSpinning: " + this.mSpinning.size());
        DumpUtilsKt.withIncreasedIndent(indentingPrintWriter, new RemoteInputController$$ExternalSyntheticLambda1(this, indentingPrintWriter));
    ...
    /* access modifiers changed from: private */
    public /* synthetic */ void lambda$dump$1(IndentingPrintWriter indentingPrintWriter) {
