...
public class AppOpsControllerImpl extends BroadcastReceiver implements AppOpsController, AppOpsManager.OnOpActiveChangedListener, AppOpsManager.OnOpNotedListener, IndividualSensorPrivacyController.Callback, Dumpable {
    public static final int[] OPS = {42, 26, R$styleable.Constraint_layout_goneMarginRight, 24, 27, androidx.appcompat.R$styleable.AppCompatTheme_windowFixedHeightMajor, 100, 0, 1};
    @GuardedBy({"mActiveItems"})
    public final List<AppOpItem> mActiveItems = new ArrayList();
    public final AppOpsManager mAppOps;
    public final AudioManager mAudioManager;
    public AudioManager.AudioRecordingCallback mAudioRecordingCallback = new AudioManager.AudioRecordingCallback() {
    ...
    public final boolean updateActives(int r11, int r12, java.lang.String r13, boolean r14) {
        /*
            r10 = this;
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final void removeNoted(int r4, int r5, java.lang.String r6) {
        /*
            r3 = this;
