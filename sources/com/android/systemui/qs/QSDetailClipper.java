...
public class QSDetailClipper {
    ...
    public final AnimatorListenerAdapter mGoneOnEnd = new AnimatorListenerAdapter() {
    ...
    public final Runnable mReverseBackground = new Runnable() {
        public void run() {
    ...
    public final AnimatorListenerAdapter mVisibleOnStart = new AnimatorListenerAdapter() {
