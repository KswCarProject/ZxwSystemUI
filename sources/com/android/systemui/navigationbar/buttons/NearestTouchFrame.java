...
public class NearestTouchFrame extends FrameLayout {
    ...
    public NearestTouchFrame(Context context, AttributeSet attributeSet, Configuration configuration) {
        ...
        this.mChildRegionComparator = new NearestTouchFrame$$ExternalSyntheticLambda2(this);
    ...
    public final void cacheClosestChildLocations() {
        if (getWidth() != 0 && getHeight() != 0) {
            ...
            Stream filter = this.mClickableChildren.stream().filter(new NearestTouchFrame$$ExternalSyntheticLambda0());
            List<View> list = this.mAttachedChildren;
            Objects.requireNonNull(list);
            filter.forEachOrdered(new NearestTouchFrame$$ExternalSyntheticLambda3(list));
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        if (this.mIsActive) {
            ...
            if (motionEvent.getAction() == 0) {
                this.mTouchingChild = (View) this.mClickableChildren.stream().filter(new NearestTouchFrame$$ExternalSyntheticLambda0()).filter(new NearestTouchFrame$$ExternalSyntheticLambda1(this, x, y)).findFirst().orElse((Object) null);
            }
