...
public class ExpandHelper implements Gefingerpoken {
    public static final FloatProperty<ViewScaler> VIEW_SCALER_HEIGHT_PROPERTY = new FloatProperty<ViewScaler>("ViewScalerHeight") {
    ...
    public ScaleGestureDetector.OnScaleGestureListener mScaleGestureListener = new ScaleGestureDetector.SimpleOnScaleGestureListener() {
