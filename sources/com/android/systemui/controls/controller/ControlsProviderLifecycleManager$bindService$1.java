...
public final class ControlsProviderLifecycleManager$bindService$1 implements Runnable {
    ...
    public final void run() {
        ...
        if (!this.$bind) {
            ...
            try {
                if (!this.this$0.context.bindServiceAsUser(this.this$0.intent, this.this$0.serviceConnection, ControlsProviderLifecycleManager.BIND_FLAGS, this.this$0.getUser())) {
