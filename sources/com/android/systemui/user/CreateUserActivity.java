...
public class CreateUserActivity extends Activity {
    ...
    public final Dialog createDialog() {
        return this.mEditUserInfoController.createDialog(this, new CreateUserActivity$$ExternalSyntheticLambda0(this), (Drawable) null, getString(R$string.user_new_user_name), getString(R$string.user_add_user), new CreateUserActivity$$ExternalSyntheticLambda1(this), new CreateUserActivity$$ExternalSyntheticLambda2(this));
    }
    ...
    public final void addUserNow(String str, Drawable drawable) {
