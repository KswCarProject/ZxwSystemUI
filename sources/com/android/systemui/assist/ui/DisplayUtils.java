...
public class DisplayUtils {
    ...
    public static int getCornerRadiusDefault(Context context) {
        int identifier;
        if (SystemProperties.getInt("vendor.display.disable_rounded_corner", 0) != 1 && (identifier = context.getResources().getIdentifier("config_rounded_mask_size", "dimen", ThemeOverlayApplier.SYSUI_PACKAGE)) > 0) {
