...
public class ConfigurableTexts {
    ...
    public final Runnable mUpdateAll = new Runnable() {
        public void run() {
    ...
    public final void setTextSizeH(TextView textView, int i) {
        textView.setTextSize(2, (float) i);
    }

    public final void setTextLabelH(TextView textView, int i) {
        if (i >= 0) {
            try {
