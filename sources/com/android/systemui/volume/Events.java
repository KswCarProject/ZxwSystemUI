...
public class Events {
    ...
    public enum VolumeDialogOpenEvent implements UiEventLogger.UiEventEnum {
        ...
        public static VolumeDialogOpenEvent fromReasons(int i) {
            if (i == 1) {
    ...
    public enum VolumeDialogCloseEvent implements UiEventLogger.UiEventEnum {
        ...
        public static VolumeDialogCloseEvent fromReason(int i) {
            if (i == 1) {
    ...
    public enum VolumeDialogEvent implements UiEventLogger.UiEventEnum {
        ...
        public static VolumeDialogEvent fromIconState(int i) {
            if (i == 1) {
        ...
        public static VolumeDialogEvent fromSliderLevel(int i) {
            return i == 0 ? VOLUME_DIALOG_SLIDER_TO_ZERO : VOLUME_DIALOG_SLIDER;
        }

        public static VolumeDialogEvent fromKeyLevel(int i) {
            return i == 0 ? VOLUME_KEY_TO_ZERO : VOLUME_KEY;
        }

        public static VolumeDialogEvent fromRingerMode(int i) {
            if (i == 0) {
    ...
    public enum ZenModeEvent implements UiEventLogger.UiEventEnum {
        ...
        public static ZenModeEvent fromZenMode(int i) {
            if (i == 0) {
                return ZEN_MODE_OFF;
            }
            if (i == 1) {
    ...
    public static String iconStateToString(int i) {
        if (i == 1) {
            return "unmute";
        }
        if (i == 2) {
