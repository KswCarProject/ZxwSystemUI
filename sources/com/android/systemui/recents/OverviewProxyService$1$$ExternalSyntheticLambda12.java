...
public final /* synthetic */ class OverviewProxyService$1$$ExternalSyntheticLambda12 implements Runnable {
    ...
    public /* synthetic */ OverviewProxyService$1$$ExternalSyntheticLambda12(OverviewProxyService.AnonymousClass1 r1, float f) {
        this.f$0 = r1;
        this.f$1 = f;
    }

    public final void run() {
        this.f$0.lambda$onAssistantProgress$13(this.f$1);
    }
}
