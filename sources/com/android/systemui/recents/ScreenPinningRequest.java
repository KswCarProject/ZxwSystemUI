...
public class ScreenPinningRequest implements View.OnClickListener, NavigationModeController.ModeChangedListener {
    ...
    public class RequestWindowView extends FrameLayout {
            ...
            this.mUpdateLayoutRunnable = new Runnable() {
                public void run() {
                    if (RequestWindowView.this.mLayout != null && RequestWindowView.this.mLayout.getParent() != null) {
                        ViewGroup r0 = RequestWindowView.this.mLayout;
                        RequestWindowView requestWindowView = RequestWindowView.this;
                        r0.setLayoutParams(ScreenPinningRequest.this.getRequestLayoutParams(requestWindowView.getRotation(requestWindowView.mContext)));
                    }
                }
            };
        ...
        public final void inflateView(int i) {
            ...
            boolean booleanValue = ((Boolean) optional.map(new ScreenPinningRequest$RequestWindowView$$ExternalSyntheticLambda0()).orElse(Boolean.FALSE)).booleanValue();
            ...
            NavigationBarView navigationBarView = (NavigationBarView) optional.map(new ScreenPinningRequest$RequestWindowView$$ExternalSyntheticLambda1()).orElse((Object) null);
