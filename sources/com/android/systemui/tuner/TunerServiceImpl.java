...
public class TunerServiceImpl extends TunerService {
    ...
    public final void upgradeTuner(int i, int i2, Handler handler) {
        String value;
    ...
    public final void addTunable(TunerService.Tunable tunable, String str) {
    ...
    public final void reloadSetting(Uri uri) {
    ...
    public void showResetRequest(Runnable runnable) {
        ...
        systemUIDialog.setButton(-1, this.mContext.getString(R$string.qs_customize_remove), new TunerServiceImpl$$ExternalSyntheticLambda1(this, runnable));
        systemUIDialog.show();
    }
    ...
    public class Observer extends ContentObserver {
        ...
        public void onChange(boolean z, Collection<Uri> collection, int i, int i2) {
            if (i2 == TunerServiceImpl.this.mUserTracker.getUserId()) {
                for (Uri r2 : collection) {
                    TunerServiceImpl.this.reloadSetting(r2);
                }
            }
        }
    }
