...
public class NavBarTuner extends TunerPreferenceFragment {
    ...
    public void onDestroy() {
        super.onDestroy();
        this.mTunables.forEach(new NavBarTuner$$ExternalSyntheticLambda0());
    }
    ...
    public /* synthetic */ void lambda$bindLayout$2(ListPreference listPreference, String str, String str2) {
        this.mHandler.post(new NavBarTuner$$ExternalSyntheticLambda6(str2, listPreference));
    }

    public final void bindLayout(ListPreference listPreference) {
        addTunable(new NavBarTuner$$ExternalSyntheticLambda1(this, listPreference), "sysui_nav_bar");
    ...
    public final void bindButton(String str, String str2, String str3) {
        ...
        addTunable(new NavBarTuner$$ExternalSyntheticLambda3(this, str2, listPreference3, listPreference2, findPreference), str);
        ListPreference listPreference4 = listPreference2;
        NavBarTuner$$ExternalSyntheticLambda4 navBarTuner$$ExternalSyntheticLambda4 = new NavBarTuner$$ExternalSyntheticLambda4(this, str, listPreference3, findPreference, listPreference4);
        listPreference.setOnPreferenceChangeListener(navBarTuner$$ExternalSyntheticLambda4);
        listPreference2.setOnPreferenceChangeListener(navBarTuner$$ExternalSyntheticLambda4);
        findPreference.setOnPreferenceClickListener(new NavBarTuner$$ExternalSyntheticLambda5(this, findPreference, str, listPreference, listPreference4));
    }
    ...
    public /* synthetic */ void lambda$bindButton$5(String str, ListPreference listPreference, ListPreference listPreference2, Preference preference, String str2, String str3) {
        this.mHandler.post(new NavBarTuner$$ExternalSyntheticLambda9(this, str3, str, listPreference, listPreference2, preference));
    }
    ...
    public /* synthetic */ boolean lambda$bindButton$7(String str, ListPreference listPreference, Preference preference, ListPreference listPreference2, Preference preference2, Object obj) {
        this.mHandler.post(new NavBarTuner$$ExternalSyntheticLambda7(this, str, listPreference, preference, listPreference2));
        return true;
    }
    ...
    public /* synthetic */ boolean lambda$bindButton$9(Preference preference, String str, ListPreference listPreference, ListPreference listPreference2, Preference preference2) {
        ...
        new AlertDialog.Builder(getContext()).setTitle(preference2.getTitle()).setView(editText).setNegativeButton(17039360, (DialogInterface.OnClickListener) null).setPositiveButton(17039370, new NavBarTuner$$ExternalSyntheticLambda8(this, editText, preference, str, listPreference, listPreference2)).show();
        return true;
    }
    ...
    public final void setValue(String str, ListPreference listPreference, Preference preference, ListPreference listPreference2) {
    ...
    public final void setupIcons(ListPreference listPreference) {
        int[][] iArr = ICONS;
