...
public final class HueVibrantSecondary implements Hue {
    @NotNull
    public final List<Pair<Integer, Integer>> hueToRotations = CollectionsKt__CollectionsKt.listOf(new Pair(0, 18), new Pair(41, 15), new Pair(61, 10), new Pair(Integer.valueOf(R$styleable.Constraint_layout_goneMarginRight), 12), new Pair(131, 15), new Pair(181, 18), new Pair(251, 15), new Pair(301, 12), new Pair(360, 12));
