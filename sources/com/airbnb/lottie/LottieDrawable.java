...
public class LottieDrawable extends Drawable implements Drawable.Callback, Animatable {
    ...
    public final float getMaxScale(Canvas canvas) {
    ...
    public final void drawWithNewAspectRatio(Canvas canvas) {
        float f;
        if (this.compositionLayer != null) {
            int i = -1;
    ...
    public final void drawWithOriginalAspectRatio(Canvas canvas) {
        float f;
        if (this.compositionLayer != null) {
            float f2 = this.scale;
