...
public final class CollapsingTextHelper {
    ...
    public final float getCollapsedTextRightBound(RectF rectF, int i, int i2) {
        if (i2 == 17 || (i2 & 7) == 1) {
            return (((float) i) / 2.0f) + (this.collapsedTextWidth / 2.0f);
        }
    ...
    public final void getTextPaintExpanded(TextPaint textPaint2) {
    ...
    public final void getTextPaintCollapsed(TextPaint textPaint2) {
    ...
    public final float calculateFadeModeTextAlpha(float f) {
    ...
    public final float measureTextWidth(TextPaint textPaint2, CharSequence charSequence) {
    ...
    public final void drawMultilineTransition(Canvas canvas, float f, float f2) {
    ...
    public final boolean isTextDirectionHeuristicsIsRtl(CharSequence charSequence, boolean z) {
