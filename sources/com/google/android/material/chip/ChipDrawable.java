...
public class ChipDrawable extends MaterialShapeDrawable implements Drawable.Callback, TextDrawableHelper.TextDrawableDelegate {
    ...
    public final void drawChipSurface(Canvas canvas, Rect rect) {
        if (!this.isShapeThemingEnabled) {
    ...
    public final void drawChipBackground(Canvas canvas, Rect rect) {
        if (!this.isShapeThemingEnabled) {
    ...
    public final void drawChipStroke(Canvas canvas, Rect rect) {
    ...
    public final void drawCompatRipple(Canvas canvas, Rect rect) {
    ...
    public final void drawChipIcon(Canvas canvas, Rect rect) {
        if (showsChipIcon()) {
    ...
    public final void drawCheckedIcon(Canvas canvas, Rect rect) {
        if (showsCheckedIcon()) {
            calculateChipIconBounds(rect, this.rectF);
            RectF rectF2 = this.rectF;
            float f = rectF2.left;
    ...
    public final void drawCloseIcon(Canvas canvas, Rect rect) {
        if (showsCloseIcon()) {
    ...
    public final void drawDebug(Canvas canvas, Rect rect) {
    ...
    public final void calculateTextBounds(Rect rect, RectF rectF2) {
        rectF2.setEmpty();
        if (this.text != null) {
            float calculateChipIconWidth = this.chipStartPadding + calculateChipIconWidth() + this.textStartPadding;
    ...
    public final void calculateChipTouchBounds(Rect rect, RectF rectF2) {
        rectF2.set(rect);
        if (showsCloseIcon()) {
    ...
    public final void setChipSurfaceColor(ColorStateList colorStateList) {
