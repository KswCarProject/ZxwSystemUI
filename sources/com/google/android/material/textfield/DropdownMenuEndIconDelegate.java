...
public class DropdownMenuEndIconDelegate extends EndIconDelegate {
    ...
    public final void setPopupBackground(AutoCompleteTextView autoCompleteTextView) {
        if (IS_LOLLIPOP) {
    ...
    public final void addRippleEffectOnOutlinedLayout(AutoCompleteTextView autoCompleteTextView, int i, int[][] iArr, MaterialShapeDrawable materialShapeDrawable) {
    ...
    public final void addRippleEffectOnFilledLayout(AutoCompleteTextView autoCompleteTextView, int i, int[][] iArr, MaterialShapeDrawable materialShapeDrawable) {
    ...
    @SuppressLint({"ClickableViewAccessibility"})
    public final void setUpDropdownShowHideBehavior(final AutoCompleteTextView autoCompleteTextView) {
