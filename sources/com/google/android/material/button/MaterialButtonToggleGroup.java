...
public class MaterialButtonToggleGroup extends LinearLayout {
    ...
    public final void resetChildMargins(int i) {
    ...
    public final int getLastVisibleChildIndex() {
    ...
    public final int getIndexWithinVisibleButtons(View view) {
        if (!(view instanceof MaterialButton)) {
            return -1;
        }
        int i = 0;
    ...
    public final CornerData getNewCornerData(int i, int i2, int i3) {
    ...
    public final void setGeneratedIdIfNeeded(MaterialButton materialButton) {
        if (materialButton.getId() == -1) {
            materialButton.setId(ViewCompat.generateViewId());
        }
    }

    public final void setupButtonChild(MaterialButton materialButton) {
    ...
    public final LinearLayout.LayoutParams buildLayoutParams(View view) {
