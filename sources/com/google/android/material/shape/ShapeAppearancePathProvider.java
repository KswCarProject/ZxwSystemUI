...
public class ShapeAppearancePathProvider {
    ...
    public final void setCornerPathAndTransform(ShapeAppearancePathSpec shapeAppearancePathSpec, int i) {
    ...
    public final void appendCornerPath(ShapeAppearancePathSpec shapeAppearancePathSpec, int i) {
    ...
    public final void appendEdgePath(ShapeAppearancePathSpec shapeAppearancePathSpec, int i) {
        int i2 = (i + 1) % 4;
        this.scratch[0] = this.cornerPaths[i].getEndX();
        this.scratch[1] = this.cornerPaths[i].getEndY();
        this.cornerTransforms[i].mapPoints(this.scratch);
    ...
    public final float getEdgeCenterForIndex(RectF rectF, int i) {
        float[] fArr = this.scratch;
    ...
    public final CornerTreatment getCornerTreatmentForIndex(int i, ShapeAppearanceModel shapeAppearanceModel) {
        if (i == 1) {
    ...
    public final CornerSize getCornerSizeForIndex(int i, ShapeAppearanceModel shapeAppearanceModel) {
        if (i == 1) {
    ...
    public final EdgeTreatment getEdgeTreatmentForIndex(int i, ShapeAppearanceModel shapeAppearanceModel) {
        if (i == 1) {
    ...
    public final void getCoordinatesOfCorner(int i, RectF rectF, PointF pointF2) {
        if (i == 1) {
    ...
    public static final class ShapeAppearancePathSpec {
        ...
        public ShapeAppearancePathSpec(ShapeAppearanceModel shapeAppearanceModel2, float f, RectF rectF, PathListener pathListener2, Path path2) {
