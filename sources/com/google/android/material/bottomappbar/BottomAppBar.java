...
public class BottomAppBar extends Toolbar implements CoordinatorLayout.AttachedBehavior {
    ...
    public final void maybeAnimateMenuView(int i, boolean z) {
    ...
    public final void createMenuViewTranslationAnimation(final int i, final boolean z, List<Animator> list) {
    ...
    public final void translateActionMenuView(final ActionMenuView actionMenuView, final int i, final boolean z, boolean z2) {
    ...
    public final void addFabAnimationListeners(FloatingActionButton floatingActionButton) {
