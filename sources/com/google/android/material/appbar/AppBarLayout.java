...
public class AppBarLayout extends LinearLayout implements CoordinatorLayout.AttachedBehavior {
    ...
    public final void startLiftOnScrollElevationOverlayAnimation(final MaterialShapeDrawable materialShapeDrawable, boolean z) {
    ...
    public final View findLiftOnScrollTargetView(View view) {
        int i;
    ...
    public static class BaseBehavior<T extends AppBarLayout> extends HeaderBehavior<T> {
        ...
        public final boolean canScrollChildren(CoordinatorLayout coordinatorLayout, T t, View view) {
        ...
        public final void animateOffsetTo(CoordinatorLayout coordinatorLayout, T t, int i, float f) {
            int i2;
        ...
        public final void animateOffsetWithDuration(final CoordinatorLayout coordinatorLayout, final T t, int i, int i2) {
        ...
        public final int getChildIndexOnOffset(T t, int i) {
        ...
        public final void updateAccessibilityActions(CoordinatorLayout coordinatorLayout, T t) {
        ...
        public final boolean addAccessibilityScrollActions(CoordinatorLayout coordinatorLayout, T t, View view) {
            boolean z = false;
        ...
        public final void addActionToExpand(CoordinatorLayout coordinatorLayout, final T t, AccessibilityNodeInfoCompat.AccessibilityActionCompat accessibilityActionCompat, final boolean z) {
        ...
        public final int interpolateOffset(T t, int i) {
            int abs = Math.abs(i);
            int childCount = t.getChildCount();
            int i2 = 0;
            int i3 = 0;
        ...
        public final boolean shouldJumpElevationState(CoordinatorLayout coordinatorLayout, T t) {
