...
public final class HighLevelEncoder {
    ...
    public final List<State> updateStateListForChar(Iterable<State> iterable, int i) {
    ...
    public final void updateStateForChar(State state, int i, Collection<State> collection) {
    ...
    public static List<State> updateStateListForPair(Iterable<State> iterable, int i, int i2) {
        LinkedList linkedList = new LinkedList();
    ...
    public static List<State> simplifyStates(Iterable<State> iterable) {
        LinkedList linkedList = new LinkedList();
