            ...
            if (j >= 0) {
                ...
                if (segment != null) {
                    if (size() - j < j) {
                        ...
                        while (j3 < size4) {
                            byte[] bArr = segment.data;
                            int min = (int) Math.min((long) segment.limit, (((long) segment.pos) + size4) - j3);
                        ...
                        while (j6 < size6) {
                            byte[] bArr2 = segment.data;
                            int min2 = (int) Math.min((long) segment.limit, (((long) segment.pos) + size6) - j6);
                            int i3 = (int) ((((long) segment.pos) + j7) - j6);
                            while (i3 < min2) {
                                int i4 = i3 + 1;
                                if (bArr2[i3] == b2 && BufferKt.rangeEquals(segment, i4, internalArray$external__okio__android_common__okio_lib2, 1, size5)) {
