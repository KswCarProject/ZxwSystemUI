...
public class PreferenceInflater {
    ...
    public final void init(PreferenceManager preferenceManager) {
    ...
    public final PreferenceGroup onMergeRoots(PreferenceGroup preferenceGroup, PreferenceGroup preferenceGroup2) {
