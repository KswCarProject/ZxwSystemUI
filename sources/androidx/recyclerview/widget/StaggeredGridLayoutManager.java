...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    public final boolean checkSpanForGap(Span span) {
        if (this.mShouldReverseLayout) {
    ...
    public final void applyPendingSavedState(AnchorInfo anchorInfo) {
        int i;
        SavedState savedState = this.mPendingSavedState;
    ...
    public final void measureChildWithDecorationsAndMargin(View view, LayoutParams layoutParams, boolean z) {
        if (layoutParams.mFullSpan) {
            if (this.mOrientation == 1) {
    ...
    public final void attachViewToSpans(View view, LayoutParams layoutParams, LayoutState layoutState) {
    ...
    public final Span getNextSpan(LayoutState layoutState) {
        int i;
        int i2;
        int i3 = -1;
    ...
    public static class LazySpanLookup {
        ...
        public final void offsetFullSpansForRemoval(int i, int i2) {
            List<FullSpanItem> list = this.mFullSpanItems;
            if (list != null) {
                int i3 = i + i2;
                for (int size = list.size() - 1; size >= 0; size--) {
        ...
        public final void offsetFullSpansForAddition(int i, int i2) {
            List<FullSpanItem> list = this.mFullSpanItems;
            if (list != null) {
                for (int size = list.size() - 1; size >= 0; size--) {
                    FullSpanItem fullSpanItem = this.mFullSpanItems.get(size);
        ...
        public final int invalidateFullSpansAfter(int i) {
