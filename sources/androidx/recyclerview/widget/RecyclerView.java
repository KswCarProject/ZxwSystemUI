...
public class RecyclerView extends ViewGroup implements NestedScrollingChild {
    ...
    public final void createLayoutManager(Context context, String str, AttributeSet attributeSet, int i, int i2) {
    ...
    public final void nestedScrollByInternal(int i, int i2, MotionEvent motionEvent, int i3) {
        LayoutManager layoutManager = this.mLayout;
        if (layoutManager == null) {
            Log.e("RecyclerView", "Cannot scroll without a LayoutManager set. Call setLayoutManager with a non-null argument.");
        } else if (!this.mLayoutSuppressed) {
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final void pullGlows(float r7, float r8, float r9, float r10) {
        /*
            r6 = this;
            r0 = 0
    ...
    public final boolean isPreferredNextFocus(View view, View view2, int i) {
        int i2;
    ...
    public final int getDeepestFocusedViewWithId(View view) {
        int id = view.getId();
    ...
    public final void handleMissingPreInfoForChangeError(long j, ViewHolder viewHolder, ViewHolder viewHolder2) {
        int childCount = this.mChildHelper.getChildCount();
        for (int i = 0; i < childCount; i++) {
            ViewHolder childViewHolderInt = getChildViewHolderInt(this.mChildHelper.getChildAt(i));
    ...
    public final boolean didChildRangeChange(int i, int i2) {
        findMinMaxChildLayoutPositions(this.mMinMaxLayoutPositions);
        int[] iArr = this.mMinMaxLayoutPositions;
    ...
    public final void animateChange(ViewHolder viewHolder, ViewHolder viewHolder2, ItemAnimator.ItemHolderInfo itemHolderInfo, ItemAnimator.ItemHolderInfo itemHolderInfo2, boolean z, boolean z2) {
        viewHolder.setIsRecyclable(false);
        if (z) {
            addAnimatingView(viewHolder);
        }
    ...
    public final class Recycler {
        ...
        public final boolean tryBindViewHolderByDeadline(ViewHolder viewHolder, int i, int i2, long j) {
    ...
    public static abstract class LayoutManager {
        ...
        public final void detachViewInternal(int i, View view) {
        ...
        public final int[] getChildRectangleOnScreenScrollAmount(View view, Rect rect) {
            int[] iArr = new int[2];
        ...
        public final boolean isFocusedChildVisibleAfterScrolling(RecyclerView recyclerView, int i, int i2) {
