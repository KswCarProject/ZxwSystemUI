...
public class OpReorderer {
    ...
    public final void swapMoveOp(List<AdapterHelper.UpdateOp> list, int i, int i2) {
    ...
    public final void swapMoveAdd(List<AdapterHelper.UpdateOp> list, int i, AdapterHelper.UpdateOp updateOp, int i2, AdapterHelper.UpdateOp updateOp2) {
    ...
    public final int getLastMoveOutOfOrder(List<AdapterHelper.UpdateOp> list) {
        boolean z = false;
