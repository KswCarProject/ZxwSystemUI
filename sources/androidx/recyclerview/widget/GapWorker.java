...
public final class GapWorker implements Runnable {
    ...
    public final void prefetchInnerRecyclerViewWithDeadline(RecyclerView recyclerView, long j) {
    ...
    public final void flushTaskWithDeadline(Task task, long j) {
    ...
    public final void flushTasksWithDeadline(long j) {
        int i = 0;
