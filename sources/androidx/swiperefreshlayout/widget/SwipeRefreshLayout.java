...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent3, NestedScrollingParent2, NestedScrollingChild {
    ...
    public Animation.AnimationListener mRefreshListener = new Animation.AnimationListener() {
        ...
        public void onAnimationEnd(Animation animation) {
            ...
            if (swipeRefreshLayout.mRefreshing) {
                ...
                SwipeRefreshLayout swipeRefreshLayout2 = SwipeRefreshLayout.this;
                boolean z = swipeRefreshLayout2.mNotify;
    ...
    public final void startScaleUpAnimation(Animation.AnimationListener animationListener) {
    ...
    public final void animateOffsetToCorrectPosition(int i, Animation.AnimationListener animationListener) {
        this.mFrom = i;
    ...
    public final void startScaleDownReturnToStartAnimation(int i, Animation.AnimationListener animationListener) {
        this.mFrom = i;
