...
public class GridContent extends SliceContent {
    ...
    public final boolean populate(SliceItem sliceItem) {
    ...
    public final List<SliceItem> filterAndProcessItems(List<SliceItem> list) {
    ...
    public static class CellContent {
        public final ArrayList<SliceItem> mCellItems = new ArrayList<>();
        ...
        public final boolean isValidCellContent(SliceItem sliceItem) {
            String format = sliceItem.getFormat();
