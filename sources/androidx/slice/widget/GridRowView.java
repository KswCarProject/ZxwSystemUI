...
public class GridRowView extends SliceChildView implements View.OnClickListener, View.OnTouchListener {
    public static final int TEXT_LAYOUT = R$layout.abc_slice_secondary_text;
    public final View mForeground;
    public GridContent mGridContent;
    public final int mGutter;
    public int mHiddenItemCount;
    ...
    public final void addSeeMoreCount(int r13) {
        /*
            r12 = this;
    ...
    public final boolean addTextItem(SliceItem sliceItem, ViewGroup viewGroup, int i) {
    ...
    public final boolean addPickerItem(SliceItem sliceItem, ViewGroup viewGroup, int i, boolean z) {
