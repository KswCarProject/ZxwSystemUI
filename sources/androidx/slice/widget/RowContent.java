...
public class RowContent extends SliceContent {
    ...
    public final boolean populate(SliceItem sliceItem, boolean z) {
        boolean z2;
    ...
    public final void processContent(SliceItem sliceItem, boolean z) {
        if (z) {
    ...
    public final void determineStartAndPrimaryAction(SliceItem sliceItem) {
