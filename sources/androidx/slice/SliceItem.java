...
public final class SliceItem extends CustomVersionedParcelable {
    ...
    public static CharSequence sanitizeText(CharSequence charSequence) {
    ...
    public static boolean checkSpannedText(Spanned spanned) {
    ...
    public static Object fixSpan(Object obj) {
        if (checkSpan(obj)) {
            return obj;
        }
        return null;
