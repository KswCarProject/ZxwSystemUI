...
public class HorizontalGridView extends BaseGridView {
    public boolean mFadingHighEdge;
    public boolean mFadingLowEdge;
    public LinearGradient mHighFadeShader;
    public int mHighFadeShaderLength;
    public int mHighFadeShaderOffset;
    public LinearGradient mLowFadeShader;
    public int mLowFadeShaderLength;
    public int mLowFadeShaderOffset;
    public Bitmap mTempBitmapHigh;
    public Bitmap mTempBitmapLow;
    ...
    public final boolean needsFadingLowEdge() {
    ...
    public final boolean needsFadingHighEdge() {
    ...
    public final Bitmap getTempBitmapLow() {
    ...
    public final Bitmap getTempBitmapHigh() {
    ...
    public final void updateLayerType() {
