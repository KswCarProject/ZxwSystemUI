...
public class PickerUtility {
    public static final boolean SUPPORTS_BEST_DATE_TIME_PATTERN = true;
    ...
    public static class DateConstant {
        ...
        public DateConstant(Locale locale2, Resources resources) {
            this.locale = locale2;
    ...
    public static class TimeConstant {
        ...
        public TimeConstant(Locale locale2, Resources resources) {
            this.locale = locale2;
