...
public class Picker extends FrameLayout {
    ...
    public ArrayList<PickerValueListener> mListeners;
    ...
    public final void notifyValueChanged(int i) {
    ...
    public final void updateItemFocusable() {
