...
public class ConstraintSet {
    ...
    public final String sideToString(int i) {
        switch (i) {
            case 1:
                return "left";
            case 2:
    ...
    public static class Constraint {
        ...
        public final void fillFromConstraints(ConstraintHelper constraintHelper, int i, Constraints.LayoutParams layoutParams) {
    ...
    public final void populateConstraint(Context context, Constraint constraint, TypedArray typedArray) {
