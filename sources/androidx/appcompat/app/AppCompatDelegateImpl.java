...
public class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final boolean updateForNightMode(int r7, boolean r8) {
        /*
            r6 = this;
    ...
    public final void updateResourcesConfigurationForNightMode(int i, boolean z, Configuration configuration) {
    ...
    public final AutoNightModeManager getAutoBatteryNightModeManager(Context context) {
