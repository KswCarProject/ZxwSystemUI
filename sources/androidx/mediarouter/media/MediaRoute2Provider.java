...
public class MediaRoute2Provider extends MediaRouteProvider {
    ...
    public final MediaRouter2.ControllerCallback mControllerCallback = new ControllerCallback();
    ...
    public final MediaRouter2.RouteCallback mRouteCallback = new RouteCallback();
    public Map<String, String> mRouteIdToOriginalRouteIdMap = new ArrayMap();
    public List<MediaRoute2Info> mRoutes = new ArrayList();
    public final MediaRouter2.TransferCallback mTransferCallback = new TransferCallback();
    ...
    public final MediaRouteDiscoveryRequest updateDiscoveryRequest(MediaRouteDiscoveryRequest mediaRouteDiscoveryRequest, boolean z) {
    ...
    public class GroupRouteController extends MediaRouteProvider.DynamicGroupRouteController {
        public final Runnable mClearOptimisticVolumeRunnable = new MediaRoute2Provider$GroupRouteController$$ExternalSyntheticLambda0(this);
        ...
        public final void scheduleClearOptimisticVolume() {
