...
public class MediaRouteControllerDialog extends AlertDialog {
    ...
    public List<MediaRouter.RouteInfo> mGroupMemberRoutes;
    ...
    public Set<MediaRouter.RouteInfo> mGroupMemberRoutesRemoved;
    ...
    public final void updateVolumeControlLayout() {
        int i = 0;
    ...
    public final void rebuildVolumeGroupList(boolean z) {
    ...
    public final void animateGroupListItems(final Map<MediaRouter.RouteInfo, Rect> map, final Map<MediaRouter.RouteInfo, BitmapDrawable> map2) {
    ...
    public final void fadeInAddedRoutes() {
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final void updatePlaybackControlLayout() {
        /*
            r8 = this;
    ...
    public class VolumeChangeListener implements SeekBar.OnSeekBarChangeListener {
        public final Runnable mStopTrackingTouch = new Runnable() {
            public void run() {
                MediaRouteControllerDialog mediaRouteControllerDialog = MediaRouteControllerDialog.this;
    ...
    public class FetchArtTask extends AsyncTask<Void, Void, Bitmap> {
        ...
        public final InputStream openInputStreamByScheme(Uri uri) throws IOException {
