...
public final class MediaRouterThemeHelper {
    public static final int COLOR_DARK_ON_LIGHT_BACKGROUND_RES_ID = R$color.mr_dynamic_dialog_icon_light;
    ...
    public static Drawable getIconByDrawableId(Context context, int i) {
